	...
	return (
		<div>
			<button type="button" class="btn btn-primary">
				Reviews{" "}
				<span class="badge badge-light">{countRatings.noOfRatings}</span>
			</button>

			<p>
				{avgRating.avg} average based on {countRatings.noOfRatings} reviews
			</p>
			...
			<div class="row">
				...
				<div class="middle">
					<div class="bar-container">
						<Progress multi>
							<Progress bar animated value={progress.one} max={100}>
								{progress.one}
							</Progress>
						</Progress>
					</div>
