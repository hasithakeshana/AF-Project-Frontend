...
SignUp.propTypes = {
  ...
  const mapDispachToProps = (dispach) => {
    ...
    return {
      ...
      signUpManager : (firstName,lastName,email,password) => dispach(reduxActions.signUpManagerAction({firstName,lastName,email,password})) ,
